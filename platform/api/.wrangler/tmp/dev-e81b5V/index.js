...
// .wrangler/tmp/bundle-h7XHMf/checked-fetch.js
...
// .wrangler/tmp/bundle-h7XHMf/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/bundle-h7XHMf/middleware-loader.entry.ts
init_checked_fetch();
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();

// .wrangler/tmp/bundle-h7XHMf/middleware-insertion-facade.js
init_checked_fetch();
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
...
var clerkAuth = createMiddleware(async (c, next) => {
  ...
  try {
    ...
    let internalUserId = payload.metadata?.internalUserId;
    let orgId = payload.org_id || payload.metadata?.organizationId;
