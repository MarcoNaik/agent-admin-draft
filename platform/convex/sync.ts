...
const entityTypeValidator = v.object({
  name: v.string(),
  slug: v.string(),
  schema: v.any(),
...
const evalSuiteValidator = v.object({
  name: v.string(),
  slug: v.string(),
  agentSlug: v.string(),
  description: v.optional(v.string()),
...
export const syncOrganization = mutation({
  args: {
    ...
    evalSuites: v.optional(v.array(evalSuiteValidator)),
...
export const internalGetSyncState = internalQuery({
  args: {
    organizationId: v.id("organizations"),
    environment: environmentValidator,
  },
...
export const internalGetPullState = internalQuery({
  args: {
    organizationId: v.id("organizations"),
    environment: environmentValidator,
  },
