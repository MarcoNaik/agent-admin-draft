...
const MODEL_PRICING: Record<string, ModelPricing> = {
  "claude-haiku-4-5": { inputPerMTok: 0.80 * MARKUP, outputPerMTok: 4.0 * MARKUP },
  "claude-haiku-4.5": { inputPerMTok: 0.80 * MARKUP, outputPerMTok: 4.0 * MARKUP },
  ...
  "gpt-4o-mini": { inputPerMTok: 0.15 * MARKUP, outputPerMTok: 0.60 * MARKUP },
  "gpt-4o": { inputPerMTok: 2.50 * MARKUP, outputPerMTok: 10.0 * MARKUP },
  "gpt-4.1-nano": { inputPerMTok: 0.10 * MARKUP, outputPerMTok: 0.40 * MARKUP },
  "gpt-4.1-mini": { inputPerMTok: 0.40 * MARKUP, outputPerMTok: 1.60 * MARKUP },
  "gpt-4.1": { inputPerMTok: 2.0 * MARKUP, outputPerMTok: 8.0 * MARKUP },
  "gpt-5-nano": { inputPerMTok: 0.05 * MARKUP, outputPerMTok: 0.40 * MARKUP },
  ...
  "gpt-5.4-pro": { inputPerMTok: 2.50 * MARKUP, outputPerMTok: 10.0 * MARKUP },
  "gpt-5.4": { inputPerMTok: 1.50 * MARKUP, outputPerMTok: 6.0 * MARKUP },
  "o1": { inputPerMTok: 15.0 * MARKUP, outputPerMTok: 60.0 * MARKUP },
  "o1-mini": { inputPerMTok: 1.10 * MARKUP, outputPerMTok: 4.40 * MARKUP },
  "o1-pro": { inputPerMTok: 150.0 * MARKUP, outputPerMTok: 600.0 * MARKUP },
  "o3": { inputPerMTok: 2.0 * MARKUP, outputPerMTok: 8.0 * MARKUP },
  "o3-mini": { inputPerMTok: 1.10 * MARKUP, outputPerMTok: 4.40 * MARKUP },
  "o3-pro": { inputPerMTok: 20.0 * MARKUP, outputPerMTok: 80.0 * MARKUP },
  "o4-mini": { inputPerMTok: 1.10 * MARKUP, outputPerMTok: 4.40 * MARKUP },

  "gemini-2.0-flash": { inputPerMTok: 0.10 * MARKUP, outputPerMTok: 0.40 * MARKUP },
  "gemini-2.5-flash": { inputPerMTok: 0.15 * MARKUP, outputPerMTok: 0.60 * MARKUP },
  "gemini-2.5-pro": { inputPerMTok: 1.25 * MARKUP, outputPerMTok: 10.0 * MARKUP },
  "gemini-3-flash": { inputPerMTok: 0.10 * MARKUP, outputPerMTok: 0.40 * MARKUP },
  "gemini-3.1-pro-preview": { inputPerMTok: 1.25 * MARKUP, outputPerMTok: 10.0 * MARKUP },

  "grok-3": { inputPerMTok: 3.0 * MARKUP, outputPerMTok: 15.0 * MARKUP },
  "grok-3-mini": { inputPerMTok: 0.30 * MARKUP, outputPerMTok: 0.50 * MARKUP },
  "grok-4": { inputPerMTok: 3.0 * MARKUP, outputPerMTok: 15.0 * MARKUP },
...
export function isModelPricingKnown(model: string): boolean {
  ...
  if (MODEL_PRICING[normalized]) return true
...
export function estimateMaxCost(model: string, maxTokens?: number): number {
  const pricing = resolvePricing(model)
  const outputTokens = (maxTokens ?? 4096) * 10
  const costUsd = (10000 * pricing.inputPerMTok + outputTokens * pricing.outputPerMTok) / 1_000_000
  return Math.round(costUsd * 1_000_000) * 3
}
