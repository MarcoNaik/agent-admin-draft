      ...
      <div className="space-y-1.5">
        {actions.map((action, i) => (
          <div key={i} className="flex items-start gap-2">
            <div className="flex h-4 w-4 shrink-0 items-center justify-center rounded bg-background-tertiary text-[10px] font-medium text-content-tertiary mt-0.5">
              {i + 1}
            </div>
  ...
  if (executions.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-8">
        <Clock className="h-4 w-4 text-content-tertiary mb-2" />
      ...
      <TabsContent value="definition" className="mt-4">
        <div className="space-y-4">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <ArrowRight className="h-4 w-4 text-content-tertiary/40" />
