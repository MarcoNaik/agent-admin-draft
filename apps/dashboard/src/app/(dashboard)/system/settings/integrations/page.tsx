...
import { MessageSquare, Calendar, Database, Mail, CreditCard, CheckCircle, XCircle, Loader2 } from "@/lib/icons"
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-3">
        ...
        <IntegrationCard
          ...
          href="/system/settings/integrations/whatsapp"
        ...
        <IntegrationCard
          ...
          href="/system/settings/integrations/resend"
          icon={<Mail className="h-4 w-4 text-primary" />}
          status={getResendStatus()}
        />
      </div>
      ...
      <div className="space-y-3">
        ...
        <IntegrationCard
          ...
          href="/system/settings/integrations/google"
      ...
      <div className="space-y-3">
        ...
        <IntegrationCard
          ...
          href="/system/settings/integrations/airtable"
      ...
      <div className="space-y-3">
        ...
        <IntegrationCard
          ...
          href="/system/settings/integrations/flow"
