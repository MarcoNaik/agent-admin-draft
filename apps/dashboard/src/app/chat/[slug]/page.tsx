...
import { useAgentBySlug, useSendChatMessageBySlug, useThreadWithMessages, useCreateThread } from "@/hooks/use-convex-data"
...
export default function ChatPage() {
  ...
  const sendMessage = useSendChatMessageBySlug()
  ...
  if (agent === null) {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-background gap-4">
        ...
        <p className="text-content-secondary">No agent with slug "{slug}" exists in your organization.</p>
      </div>
    )
  }
