...
const translations = {
  es: {
    ...
    pricing: {
      title: "Gratis para construir",
      subtitle: "Trae tus propias API keys y desarrolla localmente con el CLI. La plataforma no te cobra nada.",
      freeBadge: "Gratis para desarrollo",
      freePrice: "$0",
      freePriceNote: "con tus propias API keys",
      freeFeatures: [
        "Agentes ilimitados",
      ...
      freeHow: "Configura tus keys de OpenAI, Anthropic o xAI y corre struere dev en tu terminal. Acceso completo a la plataforma, cero costo.",
      freeCta: "Empezar a construir",
      freeNote: "Sin tarjeta de cr\u00e9dito \u00b7 Sin compromiso",
      managedTitle: "Uso de API en producci\u00f3n",
      managedNote: "Cuando tus agentes atienden tr\u00e1fico real v\u00eda la API de Struere, cobramos por token a tarifa del proveedor + 10%. Trae tus propias keys en el panel de Providers para evitar el markup.",
      tableInput: "Input",
      tableOutput: "Output",
  ...
  en: {
    ...
    pricing: {
      title: "Free to build",
      subtitle: "Bring your own API keys and develop locally with the CLI. The platform charges you nothing.",
      freeBadge: "Free for development",
      freePrice: "$0",
      freePriceNote: "with your own API keys",
      freeFeatures: [
        "Unlimited agents",
        "All integrations",
      ...
      freeHow: "Set up your OpenAI, Anthropic, or xAI keys and run struere dev in your terminal. Full platform access, zero cost.",
      freeCta: "Start building",
      freeNote: "No credit card \u00b7 No commitment",
      managedTitle: "Production API usage",
      managedNote: "When your agents handle live traffic via the Struere API, we charge per token at provider rates + 10%. Bring your own keys in the Providers panel to skip the markup.",
      tableInput: "Input",
      tableOutput: "Output",
      tableDefault: "Default",
